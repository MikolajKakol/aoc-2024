...
interface Day {
    suspend fun part1(input: List<String>): Any = input
    suspend fun part2(input: List<String>): Any = input

}

open class DayTest(var day: Day, private val hasSameInputBetweenDays: Boolean = true) {
    ...
    fun testPart1(expected: Any) {
        solvePart1(expected, "test1")
    }

    fun testPart2(expected: Any) {
